					...
					<div class="container">
													...
													<li class="item product product-item">
														<div class="product">
															<a class="product-item-photo" href="#" title="Long sleeve overall">
																...
																<img class="product-image-photo" src="/VAST/images/demo/T-shirt.jpg" alt="Long sleeve overall">
																</span>
																</span>
															</a>
													...
													<li class="item product product-item">
														<div class="product">
															<a class="product-item-photo" href="#" title="Lace back mini dress">
																<span class="product-image-container">
																<span class="product-image-wrapper">
																<img class="product-image-photo" src="/VAST/images/products/product-20.jpg" alt="Lace back mini dress">
																</span>
																</span>
															</a>
															<div class="product-item-details">
													...
													<li class="item product product-item">
														<div class="product">
															<a class="product-item-photo" href="#" title="Backless mini dress">
																<span class="product-image-container">
																<span class="product-image-wrapper">
																<img class="product-image-photo" src="/VAST/images/products/product-7.jpg" alt="Backless mini dress">
																</span>
																</span>
															</a>
															<div class="product-item-details">
						...
						<div class="header-links">
							...
							<div class="header-link header-select dropdown-link header-language">
								<a href="#"><img src="/VAST/images/flags/eng.png" alt /></a>
								<ul class="dropdown-container">
									<li class="active">
										<a href="#"><img src="/VAST/images/flags/eng.png" alt />English</a>
									</li>
									<li>
										<a href="#"><img src="/VAST/images/flags/fr.png" alt />French</a>
									</li>
									<li>
										<a href="#"><img src="/VAST/images/flags/den.png" alt />German</a>
									</li>
								</ul>
							</div>
							<!-- /Header Language -->
						...
						<div class="header-logo">
							<a href="index.html" title="Logo"><img src="/VAST/images/logo.png" alt="Logo" /></a>
						</div>
						<!-- /Logo -->
						<!-- Mobile Menu -->
									...
									<div class="sub-menu">
										<div class="container">
											<div class="megamenu-categories column-4">
												<!-- megamenu column -->
												<div class="col">
													<a class="category-image" href="#"><img src="/VAST/images/category/megamenu-category-03.jpg" alt /></a>
												...
												<!-- megamenu column -->
												<div class="col">
													<a class="category-image" href="#"><img src="/VAST/images/category/megamenu-category-04.jpg" alt /></a>
												...
												<!-- megamenu column -->
												<div class="col">
													<a class="category-image" href="#"><img src="/VAST/images/category/megamenu-category-05.jpg" alt /></a>
												...
												<!-- megamenu column -->
												<div class="col">
													<a class="category-image" href="#"><img src="/VAST/images/category/megamenu-category-06.jpg" alt /></a>
										...
										<div class="container">
											<div class="megamenu-right width-25">
												<div class="banner style-1 autosize-text" data-fontratio="4.2">
													<img src="/VAST/images/banners/banner-1.jpg" alt="Banner">
											...
											<div class="megamenu-categories column-2">
												<!-- megamenu column 1 -->
												<div class="col">
													<a class="category-image" href="#"><img src="/VAST/images/category/megamenu-category-01.jpg" alt /></a>
												...
												<!-- megamenu column 2 -->
												<div class="col">
													<a class="category-image" href="#"><img src="/VAST/images/category/megamenu-category-02.jpg" alt /></a>
                                                ...
                                                <!-- megamenu bottom -->
                                           		<div class="megamenu-bottom">
                                               		<a href="#"><img class="img-responsive" src="/VAST/images/banners/banner-megamenu.jpg" alt="megamenu banner"></a>
                                               	</div>
                                               	<!-- /megamenu bottom -->
											</div>
										</div>
									...
									<div class="sub-menu">
										<div class="container">
											<div class="megamenu-left width-33">
												<a href="#bannerLink" class="banner-wrap">
													<div class="banner style-13 autosize-text image-hover-scale" data-fontratio="4">
														<img src="/VAST/images/banners/banner-21.jpg" alt="Banner">
											...
											<div class="megamenu-categories column-3">
												<!-- megamenu column 1 -->
												<div class="col">
													<a class="category-image light" href="#"><img src="/VAST/images/category/megamenu-category-07.jpg" alt /></a>
												...
												<!-- megamenu column 2 -->
												<div class="col">
													<a class="category-image light" href="#"><img src="/VAST/images/category/megamenu-category-09.jpg" alt /></a>
												...
												<!-- megamenu column 3 -->
												<div class="col">
													<a class="category-image light" href="#"><img src="/VAST/images/category/megamenu-category-08.jpg" alt /></a>
							...
							<li class="product-nav">
								<i class="icon icon-angle-left"></i><a href="#" class="product-nav-prev">prev product
									<span class="product-nav-preview">
										<span class="image"><img src="/VAST/images/products/product-prev-preview.jpg" alt=""><span class="price">$280</span></span>
										<span class="name">Black swimsuit</span>
									</span></a>/
								<a href="#" class="product-nav-next">next product
									<span class="product-nav-preview">
										<span class="image"><img src="/VAST/images/products/product-next-preview.jpg" alt=""><span class="price">$280</span></span>
										<span class="name">Black swimsuit</span>
						...
						<div class="row">
							<div class="col-sm-6 col-md-6 col-lg-4">
								...
								<div class="main-image">
									<img src="/VAST/images/products/large/product-gallery-1.jpg" class="zoom" alt="" data-zoom-image="/VAST/images/products/large/product-gallery-1.jpg" />
									<div class="dblclick-text"><span>Double click for enlarge</span></div>
									<a href="https://www.youtube.com/watch?v=znSGGQu-yro" class="video-link"><i class="icon icon-film"></i></a>
									<a href="/VAST/images/demo/T-shirt.jpg" class="zoom-link"><i class="icon icon-zoomin"></i></a>
								</div>
								<div class="product-previews-wrapper">
									<div class="product-previews-carousel" id="previewsGallery">
										<a href="#" data-image="/VAST/images/products/large/product-gallery-1.jpg" data-zoom-image="/VAST/images/products/large/product-gallery-1.jpg"><img src="/VAST/images/products/large/product-gallery-1.jpg" alt="" /></a>
										<a href="#" data-image="/VAST/images/products/large/product-gallery-2.jpg" data-zoom-image="/VAST/images/products/large/product-gallery-1.jpg"><img src="/VAST/images/products/large/product-gallery-1.jpg" alt="" /></a>
										<a href="#" data-image="/VAST/images/products/large/product-gallery-3.jpg" data-zoom-image="/VAST/images/products/large/product-gallery-1.jpg"><img src="/VAST/images/products/large/product-gallery-1.jpg" alt="" /></a>
								...
								<div class="product-info-block classic">
									...
									<div class="product-options">
										...
										<div class="product-color swatches">
											...
											<ul class="color-list">
												<li class="absent-option"><a href="#" data-toggle="tooltip" data-placement="top" title="Red" data-value="Red" data-image="/VAST/images/products/product-color-red.jpg"><span class="value"><img src="/VAST/images/colorswatch/color-red.png" alt=""></span></a></li>
												<li><a href="#" data-toggle="tooltip" data-placement="top" title="Pink" data-value="Green" data-image="/VAST/images/products/product-color-green.jpg"><span class="value"><img src="/VAST/images/colorswatch/color-green.png" alt=""></span></a></li>
												<li><a href="#" data-toggle="tooltip" data-placement="top" title="Marine" data-value="Blue" data-image="/VAST/images/products/product-color-blue.jpg"><span class="value"><img src="/VAST/images/colorswatch/color-blue.png" alt=""></span></a></li>
												<li><a href="#" data-toggle="tooltip" data-placement="top" title="Orange" data-value="yellow" data-image="/VAST/images/products/product-color-yellow.jpg"><span class="value"><img src="/VAST/images/colorswatch/color-yellow.png" alt=""></span></a></li>
												<li><a href="#" data-toggle="tooltip" data-placement="top" title="Orange" data-value="grey" data-image="/VAST/images/products/product-color-grey.jpg"><span class="value"><img src="/VAST/images/colorswatch/color-grey.png" alt=""></span></a></li>
												<li><a href="#" data-toggle="tooltip" data-placement="top" title="Orange" data-value="grey" data-image="/VAST/images/products/product-color-violet.jpg"><span class="value"><img src="/VAST/images/colorswatch/color-violet.png" alt=""></span></a></li>
											</ul>
										</div>
						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="blog-carousel">
									<div class="blog-item">
										<a href="blog.html" class="blog-item-photo"> <img class="product-image-photo" src="/VAST/images/blog/blog-1.jpg" alt="From Blog"> </a>
									...
									<!-- Blog Carousel Item -->
									<div class="blog-item">
										<a href="blog.html" class="blog-item-photo"> <img class="product-image-photo" src="/VAST/images/blog/blog-2.jpg" alt="From Blog"> </a>
										<div class="blog-item-info">
									...
									<!-- Blog Carousel Item -->
									<div class="blog-item">
										<a href="blog.html" class="blog-item-photo"> <img class="product-image-photo" src="/VAST/images/blog/blog-3.jpg" alt="From Blog"> </a>
										<div class="blog-item-info">
									...
									<!-- Blog Carousel Item -->
									<div class="blog-item">
										<a href="blog.html" class="blog-item-photo"> <img class="product-image-photo" src="/VAST/images/blog/blog-4.jpg" alt="From Blog"> </a>
										<div class="blog-item-info">
													...
													<div class="product-item-photo">
														...
														<div class="product-item-gallery">
															...
															<div class="product-item-gallery-main">
																<a href="#"><img class="product-image-photo" src="/VAST/images/products/product-13.jpg" alt=""></a>
											...
											<div class="product-item-inside">
												<div class="product-item-info">
													...
													<div class="product-item-photo">
														...
														<!-- product main photo -->
														<div class="product-item-gallery-main">
															<a href="#"><img class="product-image-photo" src="/VAST/images/products/product-11-1.jpg" alt=""></a>
															<a href="quick-view.html" title="Quick View" class="quick-view-link quick-view-btn"> <i class="icon icon-eye"></i><span>Quick View</span></a>
														</div>
														<!-- /product main photo  -->
														<!-- Product Actions -->
														...
														<div class="product-item-gallery-previews-wrapper">
															<div class="product-item-gallery-previews">
																<div class="item">
																	<a href="#"><img src="/VAST/images/products/product-11.jpg" alt=""></a>
																</div>
																<div class="item">
																	<a href="#"><img src="/VAST/images/products/product-11-1.jpg" alt=""></a>
																</div>
																<div class="item">
																	<a href="#"><img src="/VAST/images/products/product-11-2.jpg" alt=""></a>
																</div>
															</div>
															<div class="carousel-arrows"></div>
														</div>
											...
											<div class="product-item-inside">
												<div class="product-item-info">
													...
													<div class="product-item-photo">
														<!-- product main photo -->
														<div class="product-item-gallery-main">
															<a href="#"><img class="product-image-photo" src="/VAST/images/products/product-19.jpg" alt=""></a>
															<a href="quick-view.html" title="Quick View" class="quick-view-link quick-view-btn"> <i class="icon icon-eye"></i><span>Quick View</span></a>
														</div>
														<!-- /product main photo  -->
														<!-- Product Label -->
														...
														<div class="product-item-gallery-previews-wrapper">
															<div class="product-item-gallery-previews">
																<div class="item">
																	<a href="#"><img src="/VAST/images/products/product-19.jpg" alt=""></a>
																</div>
																<div class="item">
																	<a href="#"><img src="/VAST/images/products/product-19-1.jpg" alt=""></a>
																</div>
																<div class="item">
																	<a href="#"><img src="/VAST/images/products/product-19-2.jpg" alt=""></a>
																</div>
																<div class="item">
																	<a href="#"><img src="/VAST/images/products/product-19-3.jpg" alt=""></a>
																</div>
															</div>
															<div class="carousel-arrows"></div>
														</div>
														...
														<ul class="color-swatch hidden-xs">
															<li class="active">
																<a data-image="/VAST/images/products/product-19.jpg" href="#"><img src="/VAST/images/colorswatch/color-yellow.png" alt="Yellow"></a>
															</li>
															<li>
																<a data-image="/VAST/images/products/product-19-c1.jpg" href="#"><img src="/VAST/images/colorswatch/color-blue.png" alt="Blue"></a>
															</li>
															<li>
																<a data-image="/VAST/images/products/product-19-c2.jpg" href="#"><img src="/VAST/images/colorswatch/color-red.png" alt="Red"></a>
															</li>
															<li>
																<a data-image="/VAST/images/products/product-19-c3.jpg" href="#"><img src="/VAST/images/colorswatch/color-grey.png" alt="Grey"></a>
															</li>
															<li>
																<a data-image="/VAST/images/products/product-19-c4.jpg" href="#"><img src="/VAST/images/colorswatch/color-green.png" alt="Green"></a>
															</li>
															<li>
																<a data-image="/VAST/images/products/product-19-c5.jpg" href="#"><img src="/VAST/images/colorswatch/color-violet.png" alt="Violet"></a>
															</li>
														</ul>
													</div>
													<!-- /Product Photo -->
		...
		<div class="productstack-content">
			<div class="products-list-wrapper">
				<ul class="products-list">
					<li>
						<a href="product.html" title="Product Name Long Name"><img class="product-image-photo" src="/VAST/images/products/product-10.jpg" alt=""></a> <span class="item-qty">3</span>
					...
					<li>
						<a href="product.html" title="Product Name Long Name"><img class="product-image-photo" src="/VAST/images/products/product-11.jpg" alt=""></a> <span class="item-qty">3</span>
					...
					<li>
						<a href="product.html" title="Product Name Long Name"><img class="product-image-photo" src="/VAST/images/products/product-12.jpg" alt=""></a> <span class="item-qty">3</span>
						<div class="actions"> <a class="action edit" href="#" title="Edit item"><i class="icon icon-pencil"></i></a> <a class="action delete" href="#" title="Delete item"><i class="icon icon-trash-alt"></i></a>
							<div class="edit-qty">
								<input type="number" value="3">
								<button type="button" class="btn">Apply</button>
					...
					<li>
						<a href="product.html" title="Product Name Long Name"><img class="product-image-photo" src="/VAST/images/products/product-13.jpg" alt=""></a> <span class="item-qty">3</span>
						<div class="actions"> <a class="action edit" href="#" title="Edit item"><i class="icon icon-pencil"></i></a> <a class="action delete" href="#" title="Delete item"><i class="icon icon-trash-alt"></i></a>
							<div class="edit-qty">
								<input type="number" value="3">
								<button type="button" class="btn">Apply</button>
					...
					<li>
						<a href="product.html" title="Product Name Long Name"><img class="product-image-photo" src="/VAST/images/products/product-14.jpg" alt=""></a> <span class="item-qty">3</span>
						<div class="actions"> <a class="action edit" href="#" title="Edit item"><i class="icon icon-pencil"></i></a> <a class="action delete" href="#" title="Delete item"><i class="icon icon-trash-alt"></i></a>
							<div class="edit-qty">
								<input type="number" value="3">
								<button type="button" class="btn">Apply</button>
					...
					<li>
						<a href="product.html" title="Product Name Long Name"><img class="product-image-photo" src="/VAST/images/products/product-15.jpg" alt=""></a> <span class="item-qty">3</span>
						<div class="actions"> <a class="action edit" href="#" title="Edit item"><i class="icon icon-pencil"></i></a> <a class="action delete" href="#" title="Delete item"><i class="icon icon-trash-alt"></i></a>
							<div class="edit-qty">
								<input type="number" value="3">
								<button type="button" class="btn">Apply</button>
