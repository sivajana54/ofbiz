...
import org.apache.ofbiz.cmssite.multisite.MultiSiteRequestWrapper;
...
public class CustomWebSiteFilter implements Filter {

    public static final String MODULE = CustomWebSiteFilter.class.getName();
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        //    if (UtilValidate.isNotEmpty(webSiteAlias) && webSite == null) {
         ...
         //   }
        	webSite = EntityQuery.use(delegator).from("WebSite").where("webSiteId", webSiteId).cache().queryFirst();
