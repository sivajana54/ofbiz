    <h4 align="center"><!--<img src='../images/vamEmp_logo.png'/>--> <img src='/dynimages/Dynamusic.jpg'/></h4>
    <div class="menus col-sm-12 col-md-12" >
      <div class="row">
          ...
          <ul id="page-title" class="breadcrumb">
            <li>
             ...
             <li>
                <a href="<@ofbizUrl>dynamusicHome</@ofbizUrl>">${uiLabelMap.dynamusicHomeKey}</a>
            </li>
          ...
          <h3>${StringUtil.wrapString(uiLabelMap[pageName])}</h3>
          </#if>
  <hr width='100%'/>
