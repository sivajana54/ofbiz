				...
				<div class="footer-top">
					<div class="container">
						...
						<div class="newsletter variant2 row">
							<div class="col-sm-3">
								<a href="/" title="Logo"><img src="/vastcommerce/images/logo.png.png" alt class="img-responsive" /></a>
							</div>
							<div class="col-sm-9">
								<!-- input-group -->
								<form action="#">
						...
						<div class="row">
							<div class="col-md-6 col-lg-8">
								<div class="image-banner text-center">
									<a href="#"> <img src="/vastcommerce/images/banners/footer-banner.jpg" alt="Footer Banner" class="img-responsive"> </a>
								</div>
							</div>
							<div class=" col-md-6 col-lg-4">
								<div class="bottom-space">
									...
									<div class="footer-payment-link text-center">
										<a href="#"><img src="/vastcommerce/images/payment-logo/icon-pay-1.png" alt=""></a>
										<a href="#"><img src="/vastcommerce/images/payment-logo/icon-pay-2.png" alt=""></a>
										<a href="#"><img src="/vastcommerce/images/payment-logo/icon-pay-3.png" alt=""></a>
										<a href="#"><img src="/vastcommerce/images/payment-logo/icon-pay-4.png" alt=""></a>
